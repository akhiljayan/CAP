					...
					<div class="col-md-6">
						...
						<select class="form-control" name="student-faculty">
							...
							<c:forEach var="faculty" items="${faculties}">
								<c:choose>
									<c:when test="${faculty.facultyID == stud.studentFacultyID.facultyID}">
										<option selected value="${faculty.facultyID}">${faculty.facultyName}</option>
									</c:when>
									<c:otherwise>
					...
					<div class="col-md-6">
						...
						<select class="form-control" name="student-department">
							...
							<c:forEach var="department" items="${departments}">
								<c:choose>
									<c:when test="${department.departmentID}.equals(${stud.studentDepartmentID.departmentID})">
